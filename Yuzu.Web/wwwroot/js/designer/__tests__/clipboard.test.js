...
describe('Clipboard', () => {
    ...
    test('should handle complex group widgets correctly', () => {
        ...
        if (pastedGroup) {
            ...
            const pastedChildIds = pastedGroup.properties.childIds;
    ...
    test('should maintain correct group references with multiple groups', () => {
        ...
        pastedGroups.forEach(group => {
            const groupChildIds = group.properties.childIds;
            ...
            if (otherGroup) {
                const otherGroupChildIds = otherGroup.properties.childIds;
