...
import { createExampleReplacement } from '../core/placeholders.js';
...
export class TextWidget extends Widget {
    ...
    startEditing(event) {
        ...
        const initialPosition = Object.assign({}, this.data.position);
        const initialSize = Object.assign({}, this.data.size);
        ...
        setTimeout(() => {
            const currentPosition = Object.assign({}, this.data.position);
            const currentSize = Object.assign({}, this.data.size);
            const positionChanged = initialPosition.x !== currentPosition.x ||
                initialPosition.y !== currentPosition.y;
            const sizeChanged = initialSize.width !== currentSize.width ||
    ...
    handleTextInput(event) {
        ...
        const positionBefore = Object.assign({}, this.data.position);
        const properties = this.data.properties;
        ...
        const positionAfter = Object.assign({}, this.data.position);
        if (positionBefore.x !== positionAfter.x || positionBefore.y !== positionAfter.y) {
            ...
            this.data.position = Object.assign({}, positionBefore);
    ...
    confirmEdit() {
        ...
        const positionBefore = Object.assign({}, this.data.position);
        const sizeBefore = Object.assign({}, this.data.size);
        ...
        setTimeout(() => {
            const sizeAfter = Object.assign({}, this.data.size);
            const sizeChanged = sizeBefore.width !== sizeAfter.width ||
    ...
    togglePlaceholderView() {
        const properties = this.data.properties;
        if (!properties || !properties.hasPlaceholders)
            return false;
    ...
    setFontFamily(fontFamily) {
        ...
        this.data.properties.fontFamily = fontFamily;
        this.updateDomFromData();
    }
    /**
     * Sets the font size.
    ...
    setFontColor(color) {
        ...
        this.data.properties.fontColor = color;
        this.updateDomFromData();
    }
    /**
    ...
    setFontWeight(isBold) {
        ...
        this.data.properties.fontWeight = isBold ? 'bold' : 'normal';
        this.updateDomFromData();
    }
    /**
    ...
    setFontStyle(isItalic) {
        ...
        this.data.properties.fontStyle = isItalic ? 'italic' : 'normal';
        this.updateDomFromData();
    }
    /**
    ...
    setTextDecoration(decoration) {
        ...
        this.data.properties.textDecoration = decoration;
        this.updateDomFromData();
    }
    /**
    ...
    setTextAlign(alignment) {
        ...
        this.data.properties.textAlign = alignment;
        this.updateDomFromData();
    }
    /**
