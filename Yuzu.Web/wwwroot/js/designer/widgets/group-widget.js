...
export class GroupWidget extends Widget {
    ...
    constructor(data) {
        super(data);
        this.childIds = [];
        this.groupIconElement = null;
        // Initialize child IDs from properties or empty array
        if (data.properties && data.properties.childIds) {
        ...
        this.data.properties.childIds = this.childIds;
     ...
     */
    ensureChildrenAreNonInteractive() {
...
//# sourceMappingURL=group-widget.js.map