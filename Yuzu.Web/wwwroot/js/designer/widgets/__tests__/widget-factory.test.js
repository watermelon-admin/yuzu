...
describe('WidgetFactory', () => {
    describe('createWidget', () => {
        ...
        test('should create a base Widget when type is not recognized', () => {
            ...
            expect(console.warn).toHaveBeenCalledWith(expect.stringContaining('Widget type "unknown" not recognized'));
    ...
    describe('createQRWidget', () => {
        ...
        test('should create a QRWidget with custom image URL', () => {
            ...
            expect(imgElement === null || imgElement === void 0 ? void 0 : imgElement.getAttribute('src')).toBe('img/dummy-qr.svg');
        });
    });
    describe('createTextWidget', () => {
        ...
        test('should create a TextWidget with custom text', () => {
            ...
            const textWidgetData = widget.data;
    ...
    describe('createGroupWidget', () => {
        test('should create a GroupWidget with the specified parameters', () => {
            ...
            const groupWidgetData = widget.data;
...
//# sourceMappingURL=widget-factory.test.js.map