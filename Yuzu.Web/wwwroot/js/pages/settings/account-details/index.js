...
async function updateName() {
    ...
    const firstNameError = document.getElementById('settings-firstname-error');
    const lastNameError = document.getElementById('settings-lastname-error');
    const nameUpdateButton = document.getElementById('settings-name-update');
...
function initAccountDeletion() {
    const checkbox = document.getElementById('delete-account-checkbox');
