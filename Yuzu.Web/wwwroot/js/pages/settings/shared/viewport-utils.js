...
export function setupScrollFadeEffects(sectionId) {
    ...
    const viewportContainer = document.getElementById(viewportContainerId);
    ...
    const topFade = sectionElement.querySelector('.fade-overlay.fade-top');
    const bottomFade = sectionElement.querySelector('.fade-overlay.fade-bottom');
    // Log what we found
    ...
    const updatedContainer = document.getElementById(viewportContainerId);
    console.log('[DEBUG] Shared.viewport-utils.setupScrollFadeEffects - Container clone status:', {
        originalId: viewportContainer.id,
        newId: updatedContainer === null || updatedContainer === void 0 ? void 0 : updatedContainer.id,
        isCloneValid: !!updatedContainer,
        childrenCount: updatedContainer === null || updatedContainer === void 0 ? void 0 : updatedContainer.childElementCount
    });
 ...
 */
export function animateCardRemoval(cardElement, sectionId) {
 ...
 */
export function scrollCardIntoView(cardElement, containerId) {
    const viewportContainer = document.getElementById(containerId);
