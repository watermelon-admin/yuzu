...
export function setupScrollFadeEffects(): void {
    ...
    const viewportContainer = timeZonesSection.querySelector('.viewport-container') as HTMLElement;
    const topFade = timeZonesSection.querySelector('.fade-overlay.fade-top') as HTMLElement;
    const bottomFade = timeZonesSection.querySelector('.fade-overlay.fade-bottom') as HTMLElement;
    ...
    const updatedContainer = timeZonesSection.querySelector('.viewport-container') as HTMLElement;
