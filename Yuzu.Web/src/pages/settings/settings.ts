                ...
                if (viewportContainer && topFade && bottomFade) {
                    ...
                    if (tabId === 'time-zones') {
                        ...
                        console.log('[DEBUG] time-zone-container attributes:', {
                            'data-loaded': timeZoneContainer?.getAttribute('data-loaded'),
                            childElementCount: timeZoneContainer?.childElementCount,
                            innerHTML: timeZoneContainer?.innerHTML.substring(0, 200) + '...',
                            hasLoadingSpinner: timeZoneContainer?.querySelector('.spinner-border') !== null,
                            visibleCards: timeZoneContainer?.querySelectorAll('.settings-card').length,
                            hasLoadingPlaceholder: timeZoneContainer?.querySelector('.loading-placeholder') !== null
                        });
