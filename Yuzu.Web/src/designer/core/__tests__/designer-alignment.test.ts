...
jest.mock('../../commands/alignment-commands.js', () => {
  return {
    AlignWidgetsCommand: jest.fn().mockImplementation((
      designerReference, 
      widgetIds, 
      oldPositions, 
      newPositions, 
    ...
    DistributeWidgetsCommand: jest.fn().mockImplementation((
      designerReference, 
      widgetIds, 
      oldPositions, 
      newPositions, 
    ...
    MakeSameSizeCommand: jest.fn().mockImplementation((
      designerReference, 
      widgetIds, 
      oldSizes, 
      newSize, 
...
describe('Alignment Commands', () => {
  test('AlignWidgetsCommand should be created with correct parameters', () => {
    ...
    const designer = {} as IDesignerCommands;
    const oldPositions = [
    ...
    const command = new AlignWidgetsCommand(
      designer,
      widgetIds,
      oldPositions,
      newPositions,
    ...
    expect(AlignWidgetsCommand).toHaveBeenCalledWith(
      designer,
      widgetIds,
      oldPositions,
      newPositions,
  ...
  test('DistributeWidgetsCommand should be created with correct parameters', () => {
    ...
    const command = new DistributeWidgetsCommand(
      designer,
      widgetIds,
      oldPositions,
      newPositions,
    ...
    expect(DistributeWidgetsCommand).toHaveBeenCalledWith(
      designer,
      widgetIds,
      oldPositions,
      newPositions,
  ...
  test('MakeSameSizeCommand should be created with correct parameters', () => {
    ...
    const command = new MakeSameSizeCommand(
      designer,
      widgetIds,
      oldSizes,
      newSize,
    ...
    expect(MakeSameSizeCommand).toHaveBeenCalledWith(
      designer,
      widgetIds,
      oldSizes,
      newSize,
