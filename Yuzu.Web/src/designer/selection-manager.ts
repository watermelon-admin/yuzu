...
export class SelectionManager {
    private selectedWidgets: Set<string> = new Set();
     ...
     */
    public selectWidget(widgetId: string, addToSelection: boolean = false): void {
     ...
     */
    public deselectWidget(widgetId: string): void {
     ...
     */
    public toggleWidgetSelection(widgetId: string): void {
     ...
     */
    public getSelectedWidgetIds(): string[] {
     ...
     */
    public getReferenceWidgetId(): string | null {
    ...
    public setReferenceWidget(widgetId: string): void {
        ...
        const newSet = new Set<string>([widgetId]);
     ...
     */
    public startSelectionBox(canvasElement: HTMLElement, startPoint: Point): void {
     ...
     * @param startPoint - The starting point of the selection box.
     */
    public updateSelectionBox(currentPoint: Point, startPoint: Point): void {
        if (!this.selectionBox) {
     ...
     */
    public endSelectionBox(): Rect | null {
     ...
     */
    public selectWidgetsInRect(rect: Rect, widgets: Map<string, Widget>, addToSelection: boolean = false): void {
