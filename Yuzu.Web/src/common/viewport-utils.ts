 ...
 */
export function scrollToNewCard(
    ...
    if (!cardElement) {
        ...
        const viewportContainer = section 
            ? section.querySelector('.viewport-container') as HTMLElement
            : document.querySelector('.viewport-container') as HTMLElement;
    ...
    const viewportContainer = cardElement.closest('.viewport-container') as HTMLElement;
