...
namespace Yuzu.Data.Postgresql
{
    ...
    public class YuzuDbContext : DbContext
    {
        ...
        /// BreakTypes dataset
        /// </summary>
        public DbSet<BreakTypeEntity> BreakTypes { get; set; } = null!;
        
        /// <summary>
        /// Breaks dataset
        /// </summary>
        public DbSet<BreakEntity> Breaks { get; set; } = null!;
        ...
        /// </summary>
        public DbSet<BackgroundImageEntity> BackgroundImages { get; set; } = null!;
        ...
        /// <summary>
        /// Initializes a new instance of the YuzuDbContext class with options only
        /// </summary>
        /// <param name="options">The options to be used by the DbContext</param>
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<BreakTypeEntity>(entity =>
            {
            ...
            modelBuilder.Entity<BreakEntity>(entity =>
            {
            ...
            // Configure BackgroundImage entity using data annotations
            modelBuilder.Entity<BackgroundImageEntity>(entity =>
            {
        ...
        private void UpdateTimestamps()
        {
            ...
            {
                if (entry.Entity is BreakTypeEntity breakType)
                {
                    breakType.UpdatedAt = utcNow;
                }
                else if (entry.Entity is BreakEntity breakEntity)
                {
                    breakEntity.UpdatedAt = utcNow;
                }
                else if (entry.Entity is UserDataEntity userData)
                {
                    userData.UpdatedAt = utcNow;
                }
                else if (entry.Entity is BackgroundImageEntity backgroundImage)
                {
                    backgroundImage.UpdatedAt = utcNow;
                }
            }
        }
    }
